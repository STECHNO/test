...
const MetaProductsList = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(api + `5007/api/product?page=1&limit=${rowsPerPage}`)
      .then(({ data }) => {
  ...
  const deleteProduct = (id) => {
    ...
    axios
      .post(api + `5007/api/product/delete/` + id, config)
      .then(() => {
        axios
          .get(api + "5007/api/product")
          .then(({ data }) => {
            ...
            <div className="flex flex-1 flex-col items-center justify-center md:flex-row md:items-center md:justify-start">
              ...
              <div className="flex items-center justify-end">
                ...
                <Button
                  ...
                  variant="contained"
                  onClick={() =>
                    history.push("/e_commerce/meta_products_create")
                  }
                  aria-label="Follow"
                >
                  Create new Product
                  ...
                  .map((n, i) => {
                    ...
                    return (
                      <TableRow
                        onClick={() =>
                          history.push(
                            `/e_commerce/meta_products_edit/${n._id}`
                          )
                        }
