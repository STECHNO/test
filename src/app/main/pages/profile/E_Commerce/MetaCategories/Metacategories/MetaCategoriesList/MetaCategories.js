...
function CategoriesPage(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(api + `5007/api/categories?page=1&limit=${rowsPerPage}`)
      .then(({ data }) => {
        console.log(data);
  ...
  const deleteHandler = (id) => {
    ...
    selected.forEach((i) => {
      axios.post(api + `5007/api/categories/` + id, config).then(() => {
        axios
          .get(api + "5007/api/categories")
          .then(() => {
                  ...
                  .map((n, i) => {
                    ...
                    return (
                      <TableRow
                        onClick={() =>
                          history.push(
                            `/e_commerce/meta_categories/edit/${n._id}`
                          )
                        }
